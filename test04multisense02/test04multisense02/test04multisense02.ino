  ...
  int num=0;
  String var = "[{\"variable\": \""+temp+"\", \"value\": "+String(temp_data)+"},\n{\"variable\": \""+touch+"\", \"value\": "+String(touch_data)+"}]";
  String var2 = "[{\"variable\": \""+push+"\", \"value\": "+String(push_data)+"},\n{\"variable\": \""+light+"\", \"value\": "+String(light_data)+"}]";
  num = var.length();
